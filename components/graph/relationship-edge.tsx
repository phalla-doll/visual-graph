...
export function RelationshipEdge({
  ...
  const markerEnd = cardinality === "many" ? "url(#vg-marker-many)" : "url(#vg-marker-one)";
    ...
    <svg style={{ position: "absolute", width: 0, height: 0 }}>
      <defs>
        ...
        >
          ...
          <line x1="2" y1="6" x2="9" y2="6" stroke="currentColor" strokeWidth="1.5" />
        </marker>
        <marker
          id="vg-marker-many"
          viewBox="0 0 12 12"
        ...
        >
          ...
          <line x1="10" y1="6" x2="2" y2="2" stroke="currentColor" strokeWidth="1.5" />
          <line x1="10" y1="6" x2="2" y2="10" stroke="currentColor" strokeWidth="1.5" />
        </marker>
      </defs>
    </svg>
  );
