...
export function GraphProvider({
    ...
    const state = useGraphStore(
        useShallow((s) => ({
            ...
            sqlResults: s.sqlResults,
            sqlStatus: s.sqlStatus,
            sqlQuestion: s.sqlQuestion,
    ...
    const actions = useGraphStore(
        useShallow((s) => ({
            ...
            requestSql: s.requestSql,
            setSqlQuestion: s.setSqlQuestion,
            setSqlDialect: s.setSqlDialect,
